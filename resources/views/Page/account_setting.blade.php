...
<div class="container">
    ...
    <div class="row m-t-50">
        <div class="col-md-4">
            ...
            <a class="text-black" href="{{ route('profil') }}">
                <p class="m-t-30"><u>Profil</u></p>
            </a>
            <p>Edit Profile</p>
            <a class="text-black" href="{{ route('password.index') }}">
            ...
            <form action="{{ route('account.updateInfo', Auth::user()->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 m-t-15">
                        ...
                        <textarea type="text" style="height: 130px" class="input form-control @error('bio') is-invalid @enderror" name="bio">{{ Auth::user()->bio }}</textarea>
                        @if ($errors->has('bio'))
                            <span class="invalid-feedback" role="alert">
